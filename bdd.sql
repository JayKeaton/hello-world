...
INSERT INTO `services`(`nom`,`dateAjout`,`validation`, `adresse`, `categorie`, `telephone`, `email`, `lien_site`,`noteDeMAJ`) VALUES ("Médecins Sans Frontières","2014-04-15-15-30-52",1,"8 Rue Saint-Sabin, 75011 Paris","sante","0625523251","0001@0001","http://www.msf.fr/", "Message du contributeur pour l'admin en cas de mise à jour de son service");
INSERT INTO `services`(`nom`,`dateAjout`,`validation`, `adresse`, `categorie`, `telephone`, `email`, `lien_site`,`noteDeMAJ`) VALUES ("Les Restos du Coeur","2014-04-15-15-30-52",1,"37 rue Hermel Paris","restauration","0625523251","0003@0003","https://www.restosducoeur.org/", "Message du contributeur pour l'admin en cas de mise à jour de son service");
INSERT INTO `services`(`nom`,`dateAjout`,`validation`, `adresse`, `categorie`, `telephone`, `email`, `lien_site`,`noteDeMAJ`) VALUES ("Amitié Villette ","2014-04-11-15-30-52",1,"3 place de Joinville Paris","restauration","0625523251","0004@0004","http://www.solipam.fr/Amitie-Villette-Epicerie-solidaire,118", "Message du contributeur pour l'admin en cas de mise à jour de son service");
INSERT INTO `services`(`nom`,`dateAjout`,`validation`, `adresse`, `categorie`, `telephone`, `email`, `lien_site`,`noteDeMAJ`) VALUES ("Corot Entraide","2014-04-15-15-30-52",1,"4 rue Corot Paris","restauration","0625523251","0005@0005","http://www.corot-entraide.org/", "Message du contributeur pour l'admin en cas de mise à jour de son service");
INSERT INTO `services`(`nom`,`dateAjout`,`validation`, `adresse`, `categorie`, `telephone`, `email`, `lien_site`,`noteDeMAJ`) VALUES ("La Courte Échelle ","2014-04-15-15-30-52",0,"8 rue Gaston Tessier Paris","restauration","0625523251","0006@0006","http://www.solipam.fr/La-Courte-Echelle,112", "Message du contributeur pour l'admin en cas de mise à jour de son service");
INSERT INTO `services`(`nom`,`dateAjout`,`validation`, `adresse`, `categorie`, `telephone`, `email`, `lien_site`,`noteDeMAJ`) VALUES ("Magaliménil ","2014-04-15-15-30-52",1,"6 rue d'Eupatoria Paris","restauration","0625523251","0007@0007","http://www.notredamedelacroix.com/magalimenil/", "Message du contributeur pour l'admin en cas de mise à jour de son service");
INSERT INTO `services`(`nom`,`dateAjout`,`validation`, `adresse`, `categorie`, `telephone`, `email`, `lien_site`,`noteDeMAJ`) VALUES ("Le Marché Solidaire","2014-04-15-15-30-52",1,"12 Rue de l'Eure Paris","restauration","0625523251","0008@0008","http://lemarchesolidaire.fr/", "Message du contributeur pour l'admin en cas de mise à jour de son service");
...
INSERT INTO `descriptions`(`texte`, `langue`,`idService`) VALUES ("Médecins sans frontières est une organisation caritative privée à but humanitaire d'origine française et dont le Bureau international siège à Genève.","fr",1);
INSERT INTO `descriptions`(`texte`, `langue`,`idService`) VALUES ("Les Restaurants du cœur – Les Relais du cœur, connus sous le nom de Les Restos du cœur, est une association de loi 1901 à but non lucratif et reconnue d'utilité publique créée en France, par Coluche en 1985","fr",2);
...
INSERT INTO `seances`(`nom`, `description`, `date`, `heure`, `capacite`, `idService`) VALUES ("Dr. Nills","Consultation avec le Dr. Nills de 10h à 13h","2017-09-02", "10:30:00", 6,1);
INSERT INTO `seances`(`nom`, `description`, `date`, `heure`, `capacite`, `idService`) VALUES ("Dr. Tars","Consultation avec le Dr. Tars de 14h à 18h","2017-05-02", "14:00:00", 8,1);

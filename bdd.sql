...
INSERT INTO `descriptions`(`texte`, `langue`) VALUES ("Nous serons heureux de vous soigner","Jérémy");
INSERT INTO `descriptions`(`texte`, `langue`) VALUES ("Nous vous accueillerons avec plaisir","Jérémy");

...
INSERT INTO `services`(`nom`,`validation`, `adresse`, `categorie`, `telephone`, `email`, `lien_site`) VALUES ("SoinPourTous",0,"5 rue de Rivoli Paris","soin","0625523251","0001@0001","http://www.dofus.com/fr");
...
INSERT INTO `utilisateurs`( `pseudo`, `email`, `mdp`, `avatar`, `nom`, `prenom`, `dateNaissance`, `verification`, `adresse`, `droits`, `telephone`) VALUES ("test","test@test","test","avatar3.jpg","testN","testP","1992-06-12",1,"test","contributeur","0645884521");

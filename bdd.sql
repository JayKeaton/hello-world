...
INSERT INTO `services`(`nom`,`validation`, `adresse`, `categorie`, `telephone`, `email`, `lien_site`,`noteDeMAJ`) VALUES ("SoinPourTous",0,"5 rue de Rivoli Paris","sante","0625523251","0001@0001","http://www.dofus.com/fr", "testtestestestestestestestestestestestestestestestest");
...
INSERT INTO `utilisateurs`( `pseudo`, `email`, `mdp`, `avatar`, `nom`, `prenom`, `dateNaissance`, `verification`, adresse, `droits`, `telephone`) VALUES ("jean eude","jean.eude@kikoolol.fr",sha1("saphir"),"avatar1.jpg","jean-eude","debeaujardin","1982-06-02",1,"22 rue Vieille du Temple Paris","utilisateur","0645895121");
INSERT INTO `utilisateurs`( `pseudo`, `email`, `mdp`, `avatar`, `nom`, `prenom`, `dateNaissance`, `verification`, `adresse`, `droits`, `telephone`) VALUES ("legyllith","dieu.de.la.bonte@divinité.ciel",sha1("gentil"),"avatar2.jpg","Aurélien","dreams","1992-06-12",1,"100 rue des archives Paris","admin","0666666666");

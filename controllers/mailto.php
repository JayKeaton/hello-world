...
function envoyerMail($email, $hash, $nom, $prenom, $idu){
	...
	$message_html = "<html><head></head><body><p>Bonjour ".htmlspecialchars($nom) ." ".htmlspecialchars($prenom).".</p><p> Pour activer votre compte, veuillez cliquer sur le lien ci dessous ou le copier/coller dans votre navigateur internet.</p>

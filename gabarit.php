  ...
  <body>
    ...
    <header>
        ...
        <div id="imageBanniere">
            <a href="http://hugobriet.000webhostapp.com/?page=accueil">
                <img src="static/headerFooter/msf2.jpeg" width="120" height="80"/>
            </a>
        </div>
        <ul>
            <a href="http://www.msf.fr/">
                <li>
                    <div>
            ...
            <a href="https://www.profilplus.fr">
              <li>
                  <div>
            ...
            <a href="https://fr.wikipedia.org/wiki/Param%C3%A8tre">
                <li>
                    <div>
                        <img src="static/headerFooter/engrenages_1.png" width=20/>
                        <br/>Paramètres
                    </div>
                </li>
            </a>

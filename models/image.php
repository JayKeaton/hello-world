...
function traitementUploadImage($name, $dossierDestination, $newFilename, $listeExtensions = array("image/png", "image/jpg", "image/jpeg")){
    if (!isset($_FILES[$name])){
        ...
        elseif (!in_array($file['type'], $listeExtensions)){
            return array(false, "Veuillez utiliser une image en format png.");
        }
